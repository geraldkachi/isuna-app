...
class FacilitiesFilterScreen extends ConsumerStatefulWidget {
  const FacilitiesFilterScreen({
    super.key,
  });

  @override
  ConsumerState<FacilitiesFilterScreen> createState() =>
      _FacilitiesFilterScreenState();
}

class _FacilitiesFilterScreenState extends ConsumerState<FacilitiesFilterScreen>
